...
export const endpoints = {
  ...
  vehicleAssign:      (id: number, imei: string) => `${base}/fleet/vehicles/${id}/assign-device/${encodeURIComponent(imei)}`,
  vehicleUnassign: (id: number, imei: string) => `${base}/fleet/vehicles/${id}/unassign-device/${encodeURIComponent(imei)}`,
  ...
  vehiclesByStatus:   (status: string) => `${base}/fleet/vehicles/by-status/${encodeURIComponent(status)}`,
